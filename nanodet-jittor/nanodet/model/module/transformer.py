...
class TransformerEncoder(nn.Module):
    """TransformerEncoder (Jittor Version)."""
    def __init__(
        self, dim, num_heads, mlp_ratio, dropout_ratio=0.0,
        activation="GELU", kv_bias=False,
    ):
...
class TransformerBlock(nn.Module):
    """TransformerBlock (Jittor Version)."""
    def __init__(
        self, in_channels, out_channels, num_heads, num_encoders=1,
        mlp_ratio=1, dropout_ratio=0.0, kv_bias=False, activation="GELU",
    ):
