...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, inp, oup, stride, expand_ratio, activation='ReLU'):
        ...
        layers.extend([ConvBNReLU(hidden_dim, hidden_dim, stride=stride, groups=hidden_dim, activation=activation), nn.Conv(hidden_dim, oup, 1, stride=1, padding=0, bias=False), nn.BatchNorm(oup)])
